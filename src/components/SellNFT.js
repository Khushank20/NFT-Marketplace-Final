...
export default function SellNFT () {
    ...
    return (
        ...
        <div className="flex flex-col place-items-center mt-10" id="nftForm">
            <form className="bg-white shadow-md rounded px-80 pt-4 pb-8 mb-4">
            <h3 className="text-center font-bold text-blue-500 mb-8">Upload your NFT to the marketplace</h3>
                ...
                <div className="mb-6">
                    ...
                    <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" cols="40" rows="5" id="description" type="text" placeholder="Hero Infinity Collection" value={formParams.description} onChange={e => updateFormParams({...formParams, description: e.target.value})}></textarea>
                </div>
                <div className="mb-6">
                ...
                <button onClick={listNFT} className="font-bold mt-10 w-full bg-yellow-500 text-white rounded p-2 shadow-lg" id="list-button">
                    List NFT
                </button>
            </form>
        </div>
